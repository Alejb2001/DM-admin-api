...
{
    /// <inheritdoc />
    public partial class Phase7_GameSessions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSessions_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dice_result = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_GameSessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameSessions_CampaignId_StartedAt",
                table: "GameSessions",
                columns: new[] { "CampaignId", "StartedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_GameSessions_CreatedById",
                table: "GameSessions",
                column: "CreatedById");
        }
